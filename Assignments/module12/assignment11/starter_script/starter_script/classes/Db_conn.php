...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'allocole';//this will be your WCC username
      $dbUsr = 'allocole';//this will be your WCC username
      $dbPass = 'ojS51DUyNYSMAuS';//this will be the password found in the video.
