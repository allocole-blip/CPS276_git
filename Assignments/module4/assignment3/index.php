   ...
   <?php
   //What is the purpose of separating the functionality 
   // between index.php and processNames.php in this 
   // assignment?
$output = "";

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  //How does the $_SERVER["REQUEST_METHOD"] variable help 
  //determine when to process form submissions in PHP?
